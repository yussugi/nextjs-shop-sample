...
const Dropzone = (props: DropzoneProps) => {
  ...
  // ドラッグ状態のマウスポインターが範囲内に入っているとき
  const handleDragOver = useCallback((e: React.DragEvent<HTMLDivElement>) => {
    e.preventDefault();
    e.stopPropagation();
  }, []);

  // ドラッグ状態のマウスポインターが範囲外に消えた時にフォーカスを外す
  ...
  // ドラッグ状態のマウスポインターが範囲内に来た時にフォーカスを当てる
...
Dropzone.defaultProps = {
  acceptedFileTypes: ["image/png", "image/jepg", "image/jpg", "image/gif"],
  hasError: false,
};
